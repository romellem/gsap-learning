...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    function y(e) {
        ...
        if (
            ((r && (r.width || r.height)) ||
                !g[h] ||
                ((r = { width: parseFloat(e.getAttribute(g[h][0])), height: parseFloat(e.getAttribute(g[h][1])) }),
                'rect' !== h && 'line' !== h && ((r.width *= 2), (r.height *= 2)),
                'line' === h && ((r.x = parseFloat(e.getAttribute('x1'))), (r.y = parseFloat(e.getAttribute('y1'))), (r.width = Math.abs(r.width - r.x)), (r.height = Math.abs(r.height - r.y)))),
            'path' === h)
        )
    ...
    ((e = _gsScope._gsDefine.plugin({
        ...
        init: function(e, t, r, i) {
            ...
            return (
                ...
                (f = c),
                (d = o[0]),
                -1 === (u = h.indexOf(' ')) ? ((l = void 0 !== d ? d + '' : h), (g = h)) : ((l = h.substr(0, u)), (g = h.substr(u + 1))),
                (l = -1 !== l.indexOf('%') ? (parseFloat(l) / 100) * f : parseFloat(l)),
                (s = (g = -1 !== g.indexOf('%') ? (parseFloat(g) / 100) * f : parseFloat(g)) < l ? [g, l] : [l, g]),
                (this._length = c + 10),
                0 === o[0] && 0 === s[0]
                    ? ((n = Math.max(1e-5, s[1] - c)), (this._dash = c + n), (this._offset = c - o[1] + n), (this._offsetPT = this._addTween(this, '_offset', this._offset, c - s[1] + n, 'drawSVG')))
            ...
            if (this._firstPT) {
                ...
                this._super.setRatio.call(this, e),
                    ...
                    (this._style.strokeDasharray =
                        1 === e || 0 === e ? (this._offset < 0.001 && this._length - this._dash <= 10 ? 'none' : this._offset === this._dash ? '0px, 999999px' : this._dash + 'px,' + this._length + 'px') : this._dash + 'px,' + this._length + 'px');
            }
        },
    })).getLength = y),
        (e.getPosition = x);
