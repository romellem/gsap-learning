/*!
 * Club Greensock Licensed code shown below, modified for TESTING / NON-COMMERCIAL USE ONLY,
 * TO BE USED ON GITHUB PAGES.
 * 
 * VERSION: 0.1.8
 * DATE: 2018-05-17
...
((_gsScope = 'undefined' != typeof module && module.exports && 'undefined' != typeof global ? global : this || window)._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    _gsScope._gsDefine(
        'GSDevTools',
        ['TweenLite', 'core.Animation', 'core.SimpleTimeline', 'TimelineLite', 'utils.Draggable', 'plugins.CSSPlugin'],
        function(ge, fe, s, ue, he) {
            var me,
                ...
                _e = String.fromCharCode(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47),
                Ce = (function(e) {
                    for (
                        var t = -1 !== (window ? window.location.href : '').indexOf(String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107)) && -1 !== e.indexOf(String.fromCharCode(108, 111, 99, 97, 108, 104, 111, 115, 116)),
                            o = [
                                Se,
                                // Adding in github for now... Only testing this!
                                'github.io',
                        ...
                        'string' == typeof e &&
                            ('=' === e.charAt(1)
                                ...
                                : isNaN(e) && t.getLabelTime && -1 !== t.getLabelTime(e)
                                    ? (e = t.getLabelTime(e))
                                    : t === Be && (0 < (r = e.indexOf('=')) ? ((i = parseInt(e.charAt(r - 1) + '1', 10) * parseFloat(e.substr(r + 1))), (e = e.substr(0, r - 1))) : (i = 0), (s = Pe(e)) && (e = p(s, (o / 100) * s.duration()) + i))),
                ...
                Ee = function(t, e, o, n) {
                    var i, r;
                    if ((('mousedown' !== e && 'mouseup' !== e) || (t.style.cursor = 'pointer'), 'mousedown' === e && (r = void 0 !== t.onpointerdown ? 'pointerdown' : void 0 !== t.ontouchstart ? 'touchstart' : null)))
                        return (
                            (i = function(e) {
                ...
                Be = new ue({ data: 'root', id: 'Global Timeline', autoRemoveChildren: !1, smoothChildTiming: !0 }),
                g = new ue({ data: 'root', id: 'Global Temp', autoRemoveChildren: !1, smoothChildTiming: !0 }),
                He = ge.to(Be, 1, { time: 1, ease: Linear.easeNone, data: 'root', id: '_rootTween', paused: !0, immediateRender: !1 }),
                Re = function() {
                    var e,
                        t,
                        o = g._first;
                ...
                u = function(r) {
                    if (((this.vars = r = r || {}), (r.id = r.id || ('string' == typeof r.animation ? r.animation : we++)), (be[r.id + ''] = this), !Ce)) return (window.location.href = 'http://' + Se + _e + '?plugin=' + Te + '&source=codepen'), !1;
                    ...
                    var g,
                        ...
                        y = (function(e, t, o) {
                            ...
                            return (
                                ...
                                o &&
                                    ('string' == typeof o ? (n.style.cssText = o) : 'object' == typeof o && ((o.data = 'root'), ge.set(n, o).kill()),
                                    n.style.top && (n.style.bottom = 'auto'),
                                    n.style.width && ge.set(n, { xPercent: -50, left: '50%', right: 'auto', data: 'root' }).kill()),
                        ...
                        D = function(c, d, p) {
                            return function(e) {
                                var t,
                                    ...
                                    l = s;
                                p && (c !== N && (t = N.getBoundingClientRect()).left && (s += t.left + t.width - o.left), c !== E && (t = E.getBoundingClientRect()).left && (a -= o.left + o.width - t.left)),
                                    (m = I),
                                    this.applyBounds({ minX: s, maxX: a }),
                                    (g = v.duration() / o.width),
                                    (f = -l * g),
                                    h ? v.pause() : v.pause(f + g * this.x),
                                    this.target === S && (this.activated && (this.allowEventDefault = !1), (this.activated = !0)),
                                    (u = !0);
                            };
                        },
                        P = he.create(S, {
                        ...
                        B = he.create(N, {
                            ...
                            onRelease: function() {
                                Y < 0 && (Y = 0), Me(), (N.style.left = Y + '%'), b('in', Y), ge.set(N, { x: 0, data: 'root', display: 'block' }), I || v.resume();
                            },
                        })[0],
                        H = he.create(E, {
                            type: 'x',
                            ...
                            onRelease: function() {
                                100 < O && (O = 100), Me(), (E.style.left = O + '%'), b('out', O), ge.set(E, { x: 0, data: 'root', display: 'block' }), m || (W(), v.resume());
                            },
                        })[0],
                        R = function(e) {
                            if (!P.isPressed || e) {
                                ...
                                100 < t && (t = 100),
                                    O <= t
                                        ? !i || v.paused() || P.isDragging
                                            ? ((t === O && -1 !== s._repeat) || ((t = O), v.progress(t / 100)), I || (1 !== s.totalProgress() && -1 !== s._repeat) || V())
                                            : o || ((t = Y), v.target === s && v.target.seek(l + ((c - l) * Y) / 100), 0 < s._repeat && !Y && 100 === O ? 1 === s.totalProgress() && v.totalProgress(0, !0).resume() : v.progress(t / 100, !0).resume())
                                        : t < Y && ((t = Y), v.progress(t / 100, !0)),
                                    t !== L || e
                                        ? ((C.style.left = Y + '%'),
                                          ...
                                          u && ((S.style.transform = 'translate(-50%,0)'), (S._gsTransform.x = 0), (S._gsTransform.xPercent = -50), (u = !1)),
                                          (L = t))
                                        : v._paused !== I && G();
                            }
                        },
                        ...
                        (o = new ue({
                            ...
                            .to(t, 0.5, { rotation: 360, ease: Power3.easeInOut, transformOrigin: '50% 50%' })
                            .to(t.querySelectorAll('.loop-path'), 0.5, { fill: '#91e600', ease: Linear.easeNone }, 0),
                        o),
                        Z = function(e) {
                        ...
                        J = function() {
                            var e,
                                ...
                                n = Q.children,
                                i = 0;
                            for (a && !1 === r.globalSync ? o.unshift(a) : r.hideGlobalTimeline || o.unshift(Be), t = 0; t < o.length; t++)
                        ...
                        ee = function(e) {
                            ...
                            if (('string' == typeof e && (e = Pe(e)), e instanceof fe || console.log('GSDevTools error: invalid animation.'), e !== s)) {
                                if (
                                    (s && ((s._inProgress = Y), (s._outProgress = O)),
                                    (s = e),
                                    v && ((n = v.timeScale()), v.target === a && (a.resume(), v.kill())),
                                    (Y = s._inProgress || 0),
                                    (O = s._outProgress || 100),
                                    (N.style.left = Y + '%'),
                                    (E.style.left = O + '%'),
                                    d && (b('animation', s.vars.id), b('in', Y), b('out', O)),
                                    (l = 0),
                                    (o = Math.min(1e3, r.maxDuration || 1e3, De(s))),
                                    s === Be || !1 !== r.globalSync)
                                ) {
                                    if ((Re(), (v = He), ve && ve !== x && console.log("Error: GSDevTools can only have one instance that's globally synchronized."), (ve = x), s !== Be))
                                        for (99999999 < (c = (t = s).totalDuration()) && (c = t.duration()); t.timeline.timeline; ) (l = l / t._timeScale + t._startTime), (c = c / t._timeScale + t._startTime), (t = t.timeline);
                                    else c = Be.duration();
                                    o < c - l && (c = l + o),
                                        Be.pause(l),
                                        (He.vars.time = c),
                                    ...
                                    if ((ve === x && (ve = null), s !== a && a)) {
                                        ...
                                        o < c - l && (c = l + o), a.pause(l), (v = ge.to(a, c - l, { time: c, ease: Linear.easeNone, data: 'root' })).timeScale(n);
                                    } else v = s;
                        ...
                        ie = function(e) {
                            ...
                            v.timeScale(t),
                                b('timeScale', t),
                                I ||
                                    (v.progress() >= O / 100 ? (v.target === s && v.target.seek(l + ((c - l) * Y) / 100), v.progress(Y / 100, !0).pause()) : v.pause(),
                                    ge.delayedCall(0.01, function() {
                                        v.resume();
                                    })),
                                (ne.innerHTML = t + 'x'),
                        ...
                        re = ge.to([w('.gs-bottom'), w('.gs-top')], 0.3, { autoAlpha: 0, y: 50, ease: Power2.easeIn, data: 'root', paused: !0 }),
                        se = !1,
                        ae = function(e) {
                        ...
                        pe = function(e) {
                            ...
                            var o = r.timeScale || T('timeScale'),
                                n = t === s;
                            o && (Ye(oe, o, ne, o + 'x'), v.timeScale(o)),
                                100 === (Y = ('inTime' in r ? Ne(r.inTime, s, 0, 0) : n ? t._inProgress : 0) || 0) && !r.animation && t && (ee(Be), (Y = Ne(r.inTime, s, 0, 0) || 0)),
                                Y && ((N.style.left = Y + '%'), (N.style.display = E.style.display = 'block')),
                                (O = ('outTime' in r ? Ne(r.outTime, s, 100, Y) : n ? t._outProgress : 0) || 100) < Y && (O = 100),
                                100 !== O && ((E.style.left = O + '%'), (N.style.display = E.style.display = 'block')),
                                (i = 'loop' in r ? r.loop : T('loop')) && Z(!0),
                                r.paused && v.progress(Y / 100, !0).pause(),
                                Ae && s === Be && Fe && !1 !== r.globalSync && !I && v.time(-Fe, !0),
                                R(!0);
                        };
                    Ee(Q, 'change', te),
                        Ee(Q, 'mousedown', J),
                        ...
                        Ee(q, 'mousedown', K),
                        Ee(oe, 'change', ie),
                        'auto' === r.visibility ? (Ee(y, 'mouseout', ae), Ee(y, 'mouseover', ce)) : 'hidden' === r.visibility && ((se = !0), re.progress(1)),
                        !1 !== r.keyboard &&
                            (xe && r.keyboard
                                  ...
                                  Ee(
                                      ...
                                      (e = function(e) {
                                          ...
                                          32 === o
                                              ? G()
                                              : 38 === o
                                                  ? ((t = parseFloat(Oe(oe, -1, ne))), v.timeScale(t), b('timeScale', t))
                                                  : 40 === o
                                                      ? ((t = parseFloat(Oe(oe, 1, ne))), v.timeScale(t), b('timeScale', t))
                                                      : 37 === o
                                                          ? j()
                                                              ...
                                                              : 76 === o
                                                                  ...
                                                                  : 72 === o
                                                                      ? se
                                                                          ...
                                                                          : le()
                                                                      : 73 === o
                                                                          ? ((Y = 100 * v.progress()), b('in', Y), (N.style.left = Y + '%'), R(!0))
                                                                          : 79 === o && ((O = 100 * v.progress()), b('out', O), (E.style.left = O + '%'), R(!0));
                                      })
                                  ))),
                        ge.set(S, { xPercent: -50, x: 0, data: 'root' }),
                        ge.set(N, { xPercent: -100, x: 0, data: 'root' }),
                        (N._gsIgnore = E._gsIgnore = S._gsIgnore = A._gsIgnore = q._gsIgnore = !0),
                        ...
                        (this.update = function(e) {
                            ...
                            ve === x &&
                                ...
                                s === Be &&
                                    ...
                                    1 != (o = He.duration() / n) && n && ((Y *= o), O < 100 && (O *= o), He.seek(0), (He.vars.time = n), He.invalidate(), He.duration(n), He.time(t), (M.innerHTML = n.toFixed(2)), R(!0))));
                        }),
                        (this.kill = function() {
                            Xe(Q, 'change', te),
                                Xe(Q, 'mousedown', J),
            ...
            return (
                ...
                ge.delayedCall(2, function() {
                    ...
                    2 < u.globalRecordingTime
                        ? ge.delayedCall(u.globalRecordingTime - 2, function() {
                              ve && ve.update(), (ze = !1);
                          })
                        : (ze = !1),
                        (Ae = !1);
                ...
                (d.add = function(e, t, o, n) {
                    ...
                    if (ze && e.vars && 'root' !== i && 'ignore' !== i && 'isStart' !== i && 'isFromStart' !== i && '_draggable' !== i && !(Ae && !e._duration && e instanceof ge) && (!e.vars.onComplete || e.vars.onComplete !== e.vars.onReverseComplete)) {
                        var r = Be;
                        return (
                            He._time && (He._paused ? ((r = g), (e._recordedTime = Be.rawTime())) : ((t = (d._time - He._startTime) * He._timeScale), l || (ge.ticker.addEventListener('tick', f), (l = !0)))),
                            r.add(e, t, o, n),
                ...
                (ge.onOverwrite = function(e, t, o, n) {
                    u.logOverwrites &&
                        (n
                            ? console.log('[Overwrite warning] the following properties were overwritten: ', n, '| target:', o, '| overwritten tween: ', e, '| overwriting tween:', t)
                            : console.log('[Overwrite warning] the following tween was overwritten:', e, 'by', t)),
    ...
    (function(e) {
        ...
        'undefined' != typeof module && module.exports
            ? (require('../TweenLite.js'), require('../TimelineLite.js'), require('../plugins/CSSPlugin.js'), (module.exports = t()))
            : 'function' == typeof define && define.amd && define(['TweenLite', 'TimelineLite', 'CSSPlugin'], t);
    })(),
    ((_gsScope = 'undefined' != typeof module && module.exports && 'undefined' != typeof global ? global : this || window)._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        'use strict';
        _gsScope._gsDefine(
            ...
            function(o, we, be) {
                var Te,
                    ...
                    i,
                    r,
                    _e = { css: {}, data: '_draggable' },
                    Ce = { css: {}, data: '_draggable' },
                    ke = { css: {}, data: '_draggable' },
                    Me = { css: {} },
                    ...
                    qe = function(e) {
                        ...
                        we.to(g, 0, { overwrite: 'all', delay: 15, onComplete: g, data: '_draggable' });
                    },
                    g = function() {
                    ...
                    y = function(e, t, o, n, i) {
                        ...
                        return (
                            ...
                            '%' === n && -1 !== t.indexOf('border')
                                ...
                                : ((l.cssText = 'border:0 solid red;position:' + tt(e, 'position', !0) + ';line-height:0;'),
                                  '%' !== n && a.appendChild ? (l[s ? 'borderLeftWidth' : 'borderTopWidth'] = o + n) : ((a = e.parentNode || De.body), (l[s ? 'width' : 'height'] = o + n)),
                                  a.appendChild(p),
                    ...
                    tt = function(e, t, o) {
                        ...
                        return i || 0 === i
                            ? i
                            : (e.style[t] ? (i = e.style[t]) : (n = D(e)) ? (i = (i = n.getPropertyValue(t.replace(/([A-Z])/g, '-$1').toLowerCase())) || n.length ? i : n[t]) : e.currentStyle && (i = e.currentStyle[t]),
                              'auto' !== i ||
                                  ('top' !== t && 'left' !== t) ||
                                  (i = (function(e, t) {
                    ...
                    nt = function(e, t) {
                        ...
                        return r
                            ? F(r, t)
                            : void 0 !== e.left
                                ? ((i = rt(t)), { left: e.left - i.x, top: e.top - i.y, width: e.width, height: e.height })
                    ...
                    P = function() {
                        ...
                        De.body &&
                            ...
                            (e = r.getScreenCTM()),
                            0 === t && 0 === e.e && 0 === e.f && 1 === e.a ? ((_ = 1), (u = !0)) : ((_ = t !== e.e ? 1 : 0), (u = 1 !== e.a)),
                            c && (l.style.display = 'flex'),
                            l.removeChild(r);
                    },
                    T = '' !== m(p, 'perspective'),
                    w = m(p, 'transformOrigin')
                        .replace(/^ms/g, 'Ms')
                        .replace(/([A-Z])/g, '-$1')
                        .toLowerCase(),
                    N = m(p, 'transform'),
                    ...
                    B = [],
                    H = function(e) {
                        if (!e.getBoundingClientRect || !e.parentNode || !N) return { offsetTop: 0, offsetLeft: 0, scaleX: 1, scaleY: 1, offsetParent: Pe };
                        ...
                        for (
                            (n = f.offsetParent) === De.body && (n = Pe), B.length = O.length = 0;
                            g && ('matrix(1, 0, 0, 1, 0, 0)' !== (r = tt(g, N, !0)) && 'none' !== r && 'translate3d(0px, 0px, 0px)' !== r && (B.push(g), O.push(g.style[N]), (g.style[N] = 'none')), g !== n);
                        ...
                        for (
                            o = n.getBoundingClientRect(),
                                ...
                                f.borderBox &&
                                    ...
                                    (f.scaleX *= (d - l) / d),
                                    (f.scaleY *= (p - c) / p)),
                                h ? ((t = e.getBoundingClientRect()), (f.offsetLeft = t.left - o.left), (f.offsetTop = t.top - o.top)) : ((f.offsetLeft = a.x - o.left), (f.offsetTop = a.y - o.top)),
                                f.offsetParent = n,
                                s = B.length;
                            -1 < --s;
                    ...
                    rt = function(e, t) {
                        if (((t = t || {}), !e || e === Pe || !e.parentNode || e === window)) return { x: 0, y: 0 };
                        var o = D(e),
                        ...
                        return (
                            ...
                            e.getBBox && it(e)
                                ? (e._gsTransform || (we.set(e, { x: '+=0', overwrite: !1 }), void 0 === e._gsTransform.xOrigin && console.log('Draggable requires at least GSAP 1.17.0')),
                                  (n = e.getBBox()),
                                  (t.x = e._gsTransform.xOrigin - n.x),
                                  (t.y = e._gsTransform.yOrigin - n.y))
                                : (e.getBBox && -1 !== (r + s).indexOf('%') && (e = { offsetWidth: (e = e.getBBox()).width, offsetHeight: e.height }),
                    ...
                    R = function(e) {
                        ...
                        if (((o.isSVG = i), (o.isSVGRoot = r), (o.borderBox = 'border-box' === n.boxSizing), (o.computedStyle = n), r)) (t = e.parentNode || Pe).insertBefore(p, e), (o.offsetParent = p.offsetParent || Pe), t.removeChild(p);
                        else if (i) {
                    ...
                    z = function(e, t, o, n, i) {
                        ...
                        return (
                            (r = y.isSVG && -1 !== (e.style[N] + '').indexOf('matrix') ? e.style[N] : T ? T.getPropertyValue(E) : e.currentStyle ? e.currentStyle[N] : '1,0,0,1,0,0'),
                            ...
                            t &&
                                (void 0 === _ && P(),
                                (a = y.isSVG || y.isSVGRoot ? H(e) : e),
                                y.isSVG
                                    ? ((l = e.getBBox()), (u = b.isSVGRoot ? { x: 0, y: 0 } : w.getBBox()), (a = { offsetLeft: l.x - u.x, offsetTop: l.y - u.y, offsetParent: y.offsetParent }))
                                    : y.isSVGRoot
                                        ? ((h = parseInt(T.borderTopWidth, 10) || 0),
                                          ...
                                          (r[3] *= p),
                                          Y || ((t.x += v), (t.y += x)),
                                          S === De.body && a.offsetParent === Pe && (S = Pe))
                                        : !C && e.offsetParent && ((t.x += parseInt(tt(e.offsetParent, 'borderLeftWidth'), 10) || 0), (t.y += parseInt(tt(e.offsetParent, 'borderTopWidth'), 10) || 0)),
                                (s = w === Pe || w === De.body),
                                (r[4] = Number(r[4]) + t.x + (a.offsetLeft || 0) - o.x - (s ? 0 : w.scrollLeft || 0)),
                                (r[5] = Number(r[5]) + t.y + (a.offsetTop || 0) - o.y - (s ? 0 : w.scrollTop || 0)),
                                w && 'fixed' === tt(e, 'position', T) && ((r[4] += L()), (r[5] += M())),
                                !w ||
                                    w === Pe ||
                                    S !== a.offsetParent ||
                                    b.isSVG ||
                                    ...
                                    (r[4] -= a.offsetLeft || 0),
                                    (r[5] -= a.offsetTop || 0),
                                    C || !b.offsetParent || y.isSVG || y.isSVGRoot || ((r[4] -= parseInt(tt(b.offsetParent, 'borderLeftWidth'), 10) || 0), (r[5] -= parseInt(tt(b.offsetParent, 'borderTopWidth'), 10) || 0)))),
                            r
                        );
                    },
                    st = function(e, t) {
                        if (!e || e === window || !e.parentNode) return [1, 0, 0, 1, 0, 0];
                        for (var o, n, i, r, s, a, l, c, d = rt(e, b), p = rt(e.parentNode, S), g = z(e, d, p, !1, !t); (e = e.parentNode) && e.parentNode && e !== Pe; )
                            (d = p),
                                (p = rt(e.parentNode, d === b ? S : b)),
                                (l = z(e, d, p)),
                                (o = g[0]),
                                (n = g[1]),
                                (i = g[2]),
                                ...
                                (g[5] = s * l[1] + a * l[3] + l[5]);
                        return (
                            t && ((o = g[0]), (n = g[1]), (i = g[2]), (r = g[3]), (s = g[4]), (a = g[5]), (c = o * r - n * i), (g[0] = r / c), (g[1] = -n / c), (g[2] = -i / c), (g[3] = o / c), (g[4] = (i * a - r * s) / c), (g[5] = -(o * a - n * s) / c)), g
                        );
                    },
                    A = function(e, t, o) {
                    ...
                    F = function(e, t, o) {
                        ...
                        var n,
                            ...
                            _,
                            C = e.getBBox && it(e);
                        if (e === window) (s = M()), (r = (i = L()) + (Pe.clientWidth || e.innerWidth || De.body.clientWidth || 0)), (a = s + ((e.innerHeight || 0) - 20 < Pe.clientHeight ? Pe.clientHeight : e.innerHeight || De.body.clientHeight || 0));
                        else {
                            if (void 0 === t || t === window) return e.getBoundingClientRect();
                            (i = -(n = rt(e)).x),
                                (s = -n.y),
                                C
                                    ? ((h = (u = e.getBBox()).width), (m = u.height))
                                    : 'svg' !== (e.nodeName + '').toLowerCase() && e.offsetWidth
                                        ? ((h = e.offsetWidth), (m = e.offsetHeight))
                                        : ((S = D(e)), (h = parseFloat(S.width)), (m = parseFloat(S.height))),
                                (r = i + h),
                                (a = s + m),
                                'svg' !== e.nodeName.toLowerCase() ||
                                    Oe ||
                                    ((_ = (v = H(e)).computedStyle || {}),
                                    ...
                                    (i -= x / v.scaleX - b),
                                    (s -= y / v.scaleY - T),
                                    S && ((r += (parseFloat(_.borderRightWidth) + x) / v.scaleX), (a += (y + parseFloat(_.borderBottomWidth)) / v.scaleY)));
                        }
                        return e === t
                            ...
                            : ((l = st(e)),
                              ...
                              (We.x = We.y = 0),
                              o && rt(t, We),
                              { left: i + We.x, top: s + We.y, width: Math.max(d.x, p.x, g.x, f.x) - i, height: Math.max(d.y, p.y, g.y, f.y) - s });
                    },
                    I = function(e) {
                    ...
                    lt = (function(e) {
                        for (
                            var t = e.split(','), o = (void 0 !== p.onpointerdown ? 'pointerdown,pointermove,pointerup,pointercancel' : void 0 !== p.onmspointerdown ? 'MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel' : e).split(','), n = {}, i = 4;
                            -1 < --i;
                    ...
                    ct = function(e, t, o, n) {
                        if (e.addEventListener) {
                            var i = lt[t];
                            (n = n || { passive: !1 }), e.addEventListener(i || t, o, n), i && t !== i && e.addEventListener(t, o, n);
                    ...
                    gt = function(i, r, e, t, s, o) {
                        ...
                        if (r)
                            if (1 !== s && r instanceof Array) {
                                if (((c.end = n = []), (l = r.length), 'object' == typeof r[0])) for (a = 0; a < l; a++) n[a] = Ge(r[a], s);
                    ...
                    ft = function(e) {
                        ...
                        return (
                            ...
                            (!('true' !== (t = e.getAttribute('data-clickable')) && ('false' === t || (!e.onclick && !c.test(e.nodeName + '') && 'true' !== e.getAttribute('contentEditable')))) || ft(e.parentNode))
                        );
                    },
                    ut = function(e, t) {
                        for (var o, n = e.length; -1 < --n; ) ((o = e[n]).ondragstart = o.onselectstart = t ? null : l), et(o, 'userSelect', t ? 'text' : 'none');
                    },
                    V = ((t = De.createElement('div')),
                    ...
                    ht = function(i, r) {
                        ...
                        var s,
                            ...
                            w = 0,
                            b = 0;
                        T && !1 !== r.force3D ? ((c = 'translate3d('), (d = 'px,0px)')) : N && ((c = 'translate('), (d = 'px)')),
                            ...
                            (this.left = function(e, t) {
                                ...
                                var o = i.scrollLeft - m,
                                    n = u;
                                if ((2 < o || o < -2) && !t) return (m = i.scrollLeft), we.killTweensOf(this, !0, { left: 1, scrollLeft: 1 }), this.left(-m), void (r.onKill && r.onKill());
                                (e = -e) < 0 ? ((u = (e - 0.5) | 0), (e = 0)) : w < e ? ((u = (e - w) | 0), (e = w)) : (u = 0),
                                    (u || n) && (c ? this._suspendTransforms || (g[N] = c + -u + 'px,' + -f + d) : (g.left = -u + 'px'), 0 <= u + y && (g.paddingRight = u + y + 'px')),
                                    (i.scrollLeft = 0 | e),
                                    (m = i.scrollLeft);
                            }),
                            (this.top = function(e, t) {
                                ...
                                var o = i.scrollTop - h,
                                    n = f;
                                if ((2 < o || o < -2) && !t) return (h = i.scrollTop), we.killTweensOf(this, !0, { top: 1, scrollTop: 1 }), this.top(-h), void (r.onKill && r.onKill());
                                (e = -e) < 0 ? ((f = (e - 0.5) | 0), (e = 0)) : b < e ? ((f = (e - b) | 0), (e = b)) : (f = 0),
                            ...
                            (this.calibrate = function(e) {
                                ...
                                (h = i.scrollTop),
                                    (m = i.scrollLeft),
                                    (n && i.clientHeight === a && p.offsetHeight === l && v === i.scrollWidth && x === i.scrollHeight && !e) ||
                                        ((f || u) && ((t = this.left()), (o = this.top()), this.left(-i.scrollLeft), this.top(-i.scrollTop)),
                                        (n && !e) || ((g.display = 'block'), (g.width = 'auto'), (g.paddingRight = '0px'), (y = Math.max(0, i.scrollWidth - i.clientWidth)) && (y += tt(i, 'paddingLeft') + (V ? tt(i, 'paddingRight') : 0))),
                                        ...
                                        (g.width = '100%'),
                                        (g.paddingRight = y + 'px'),
                                        V && (g.paddingBottom = tt(i, 'paddingBottom', !0)),
                                        Oe && (g.zoom = '1'),
                                        (s = i.clientWidth),
                                        (a = i.clientHeight),
                                        (v = i.scrollWidth),
                    ...
                    mt = function(f, p) {
                        ...
                        var g,
                                ...
                                if (q.autoScroll && q.isDragging && (K || M)) {
                                    ...
                                    for (
                                        K = !1,
                                            ...
                                            i = q.pointerX - Ve.scrollLeft,
                                            r = q.pointerY - Ve.scrollTop;
                                        c && !o;
                                        ...
                                        (t = (o = Ke(c.parentNode)) ? Ve : c.parentNode),
                                            ...
                                            G &&
                                                ((l = t._gsMaxScrollY - t.scrollTop) < 0
                                                    ? (a = l)
                                                    : r > n.bottom - J && l
                                                        ? ((K = !0), (a = Math.min(l, (d * (1 - Math.max(0, n.bottom - r) / J)) | 0)))
                                                        : r < n.top + Q && t.scrollTop && ((K = !0), (a = -Math.min(t.scrollTop, (d * (1 - Math.max(0, r - n.top) / Q)) | 0))),
                                                a && (t.scrollTop += a)),
                                            V &&
                                                ((l = t._gsMaxScrollX - t.scrollLeft) < 0
                                                    ? (s = l)
                                                    : i > n.right - $ && l
                                                        ? ((K = !0), (s = Math.min(l, (d * (1 - Math.max(0, n.right - i) / $)) | 0)))
                                                        : i < n.left + ee && t.scrollLeft && ((K = !0), (s = -Math.min(t.scrollLeft, (d * (1 - Math.max(0, i - n.left) / ee)) | 0))),
                                                s && (t.scrollLeft += s)),
                                            o && (s || a) && (window.scrollTo(t.scrollLeft, t.scrollTop), he(q.pointerX + s, q.pointerY + a)),
                                            (c = t);
                                }
                                if (M) {
                                    var p = q.x,
                                    ...
                                    p < 1e-6 && -1e-6 < p && (p = 0),
                                        g < 1e-6 && -1e-6 < g && (g = 0),
                                        F
                                            ? ((q.deltaX = p - O.data.rotation), (O.data.rotation = q.rotation = p), O.setRatio(1))
                                            : u
                                                ? (G && ((q.deltaY = g - u.top()), u.top(g)), V && ((q.deltaX = p - u.left()), u.left(p)))
                                                : A
                                                    ? (G && ((q.deltaY = g - O.data.y), (O.data.y = g)), V && ((q.deltaX = p - O.data.x), (O.data.x = p)), O.setRatio(1))
                                                    : (G && ((q.deltaY = g - parseFloat(f.style.top || 0)), (f.style.top = g + 'px')), V && ((q.deltaY = p - parseFloat(f.style.left || 0)), (f.style.left = p + 'px'))),
                                        !y || e || R || ((R = !0), ot(q, 'drag', 'onDrag'), (R = !1));
                                }
                                M = !1;
                            },
                            a = function(e, t) {
                                var o,
                                    n = q.x,
                                    i = q.y;
                                f._gsTransform || (!A && !F) || we.set(f, { x: '+=0', overwrite: !1, data: '_draggable' }),
                                    A
                                        ? ((q.y = f._gsTransform.y), (q.x = f._gsTransform.x))
                                        : F
                                            ? (q.x = q.rotation = f._gsTransform.rotation)
                                            : u
                                                ? ((q.y = u.top()), (q.x = u.left()))
                                                : ((q.y = parseInt(f.style.top, 10) || 0), (q.x = parseInt(f.style.left, 10) || 0)),
                                    (L || D || P) &&
                                        !t &&
                                        (q.isDragging || q.isThrowing) &&
                                        (P && ((We.x = q.x), (We.y = q.y), (o = P(We)).x !== q.x && ((q.x = o.x), (M = !0)), o.y !== q.y && ((q.y = o.y), (M = !0))),
                                        L && (o = L(q.x)) !== q.x && ((q.x = o), F && (q.rotation = o), (M = !0)),
                                        D && ((o = D(q.y)) !== q.y && (q.y = o), (M = !0))),
                                    M && ne(!0),
                                    e || ((q.deltaX = q.x - n), (q.deltaY = q.y - i), ot(q, 'throwupdate', 'onThrowUpdate'));
                            },
                            l = function() {
                                var e, t, o, n;
                                (x = !1),
                                    u
                                        ? (u.calibrate(), (q.minX = b = -u.maxScrollLeft()), (q.minY = S = -u.maxScrollTop()), (q.maxX = w = q.maxY = T = 0), (x = !0))
                                        : p.bounds &&
                                          ((e = nt(p.bounds, f.parentNode)),
                                          F
                                              ? ((q.minX = b = e.left), (q.maxX = w = e.left + e.width), (q.minY = S = q.maxY = T = 0))
                                              : void 0 !== p.bounds.maxX || void 0 !== p.bounds.maxY
                                                  ? ((e = p.bounds), (q.minX = b = e.minX), (q.minY = S = e.minY), (q.maxX = w = e.maxX), (q.maxY = T = e.maxY))
                                                  : ((t = nt(f, f.parentNode)), (q.minX = b = tt(f, I) + e.left - t.left), (q.minY = S = tt(f, W) + e.top - t.top), (q.maxX = w = b + (e.width - t.width)), (q.maxY = T = S + (e.height - t.height))),
                                          w < b && ((q.minX = w), (q.maxX = w = b), (b = q.minX)),
                                          T < S && ((q.minY = T), (q.maxY = T = S), (S = q.minY)),
                                          F && ((q.minRotation = b), (q.maxRotation = w)),
                                          (x = !0)),
                                    p.liveSnap &&
                                        ((n = (o = !0 === p.liveSnap ? p.snap || {} : p.liveSnap) instanceof Array || 'function' == typeof o),
                                        F
                                            ? ((L = pe(n ? o : o.rotation, b, w, 1)), (D = null))
                                            : o.points
                                                ? (P = ge(n ? o : o.points, b, w, S, T, o.radius, u ? -1 : 1))
                                                : (V && (L = pe(n ? o : o.x || o.left || o.scrollLeft, b, w, u ? -1 : 1)), G && (D = pe(n ? o : o.y || o.top || o.scrollTop, S, T, u ? -1 : 1))));
                            },
                            ie = function() {
                            ...
                            se = function(e, t) {
                                ...
                                e && Se
                                    ? (!0 === e &&
                                          ((n = (o = p.snap || p.liveSnap || {}) instanceof Array || 'function' == typeof o),
                                          (e = { resistance: (p.throwResistance || p.resistance || 1e3) / (F ? 10 : 1) }),
                                          F
                                              ? (e.rotation = gt(q, n ? o : o.rotation, w, b, 1, t))
                                              : (V && (e[I] = gt(q, n ? o : o.points || o.x || o.left || o.scrollLeft, w, b, u ? -1 : 1, t || 'x' === q.lockedAxis)),
                                                G && (e[W] = gt(q, n ? o : o.points || o.y || o.top || o.scrollTop, T, S, u ? -1 : 1, t || 'y' === q.lockedAxis)),
                                                (o.points || (o instanceof Array && 'object' == typeof o[0])) && ((e.linkedProps = I + ',' + W), (e.radius = o.radius)))),
                                      (q.isThrowing = !0),
                                      ...
                                      (q.tween = i = Se.to(
                                          ...
                                          isNaN(p.maxDuration) ? 2 : p.maxDuration,
                                          isNaN(p.minDuration) ? (0 === r || ('object' == typeof e && 1e3 < e.resistance) ? 0 : 0.5) : p.minDuration,
                                          r
                                      )),
                                      p.fastMode || (u && (u._suspendTransforms = !0), i.render(i.duration(), !0, !0), a(!0, !0), (q.endX = q.x), (q.endY = q.y), F && (q.endRotation = q.x), i.play(0), a(!0, !0), u && (u._suspendTransforms = !1)))
                                    : x && q.applyBounds();
                            },
                            ae = function(e) {
                                var t,
                            ...
                            le = function() {
                                ...
                                ae(!1),
                                    X && ((h = q.pointerX * X[0] + q.pointerY * X[2] + X[4]), (m = q.pointerX * X[1] + q.pointerY * X[3] + X[5])),
                                    M && (he(q.pointerX, q.pointerY), ne(!0)),
                                    u
                                        ? (l(), (v = u.top()), (d = u.left()))
                                        : (ce() ? (a(!0, !0), l()) : q.applyBounds(),
                                          F
                                              ? ((k = q.rotationOrigin = (function(e, t, o, n, i) {
                                                    e = Je(e);
                                                    var r = st(e, !1),
                                                        s = t.x,
                                                        a = t.y;
                                                ...
                                                a(!0, !0),
                                                (d = q.x),
                                                (v = q.y = Math.atan2(k.y - q.pointerY, q.pointerX - k.x) * Ee))
                                              : ((f.parentNode && f.parentNode.scrollTop) || 0, (f.parentNode && f.parentNode.scrollLeft) || 0, (v = tt(f, W)), (d = tt(f, I)))),
                                    x && e && (w < d ? (d = w + (d - w) / e) : d < b && (d = b - (b - d) / e), F || (T < v ? (v = T + (v - T) / e) : v < S && (v = S - (S - v) / e))),
                                    (q.startX = d),
                                    (q.startY = v);
                            },
                            ce = function() {
                                    ...
                                    'function' == typeof l
                                        ? function(e) {
                                              var t,
                                                  ...
                                                  s = e.y;
                                              return (
                                                  (e.x = r = c < r ? c + (r - c) * i : r < a ? a + (r - a) * i : r),
                                                  (e.y = s = p < s ? p + (s - p) * i : s < d ? d + (s - d) * i : s),
                                                  (t = l.call(q, e)) !== e && ((e.x = t.x), (e.y = t.y)),
                                                  1 !== f && ((e.x *= f), (e.y *= f)),
                                                  g < Xe && ((o = e.x - r), (n = e.y - s), g < o * o + n * n && ((e.x = r), (e.y = s))),
                                                  e
                                              );
                                          }
                                        : l instanceof Array
                            ...
                            fe = function(e, t) {
                                ...
                                if (g && !q.isPressed && e && (('mousedown' !== e.type && 'pointerdown' !== e.type) || t || !(Ye() - oe < 30) || !lt[q.pointerEvent.type])) {
                                    if (
                                        ...
                                        (q.pointerEvent = e),
                                        lt[e.type]
                                            ? ((E = -1 !== e.type.indexOf('touch') ? e.currentTarget || e.target : De), ct(E, 'touchend', me), ct(E, 'touchmove', ue), ct(E, 'touchcancel', me), ct(De, 'touchstart', pt))
                                            : ((E = null), ct(De, 'mousemove', ue)),
                                        (H = null),
                                        ct(De, 'mouseup', me),
                                        e && e.target && ct(e.target, 'mouseup', me),
                                        (N = te.call(q, e.target) && !p.dragClickables && !t))
                                    )
                                        return ct(e.target, 'change', me), ot(q, 'press', 'onPress'), void ut(U, !0);
                                    if (
                                        ((B = !(!E || V === G || !1 === q.vars.allowNativeTouchScrolling || (q.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which))) && (V ? 'y' : 'x')),
                                        Oe ? (e = $e(e, !0)) : B || q.allowEventDefault || (e.preventDefault(), e.preventManipulation && e.preventManipulation()),
                                        e.changedTouches ? ((e = _ = e.changedTouches[0]), (C = e.identifier)) : e.pointerId ? (C = e.pointerId) : (_ = C = null),
                                        Ae++,
                                        (function(e) {
                                            He.push(e), 1 === He.length && we.ticker.addEventListener('tick', je, this, !1, 1);
                                        })(ne),
                                        (m = q.pointerY = e.pageY),
                                        (h = q.pointerX = e.pageX),
                                        (B || q.autoScroll) && Qe(f.parentNode),
                                        !f.parentNode || !q.autoScroll || u || F || !f.parentNode._gsMaxScrollX || Be.parentNode || f.getBBox || ((Be.style.width = f.parentNode.scrollWidth + 'px'), f.parentNode.appendChild(Be)),
                                        le(),
                                        q.tween && q.tween.kill(),
                                        (q.isThrowing = !1),
                                        we.killTweensOf(u || f, !0, n),
                                        u && we.killTweensOf(f, !0, { scrollTo: 1 }),
                                        (q.tween = q.lockedAxis = null),
                                        (p.zIndexBoost || (!F && !u && !1 !== p.zIndexBoost)) && (f.style.zIndex = mt.zIndex++),
                                        (q.isPressed = !0),
                                        (y = !(!p.onDrag && !q._listeners.drag)),
                                        !F)
                                    )
                                        for (o = U.length; -1 < --o; ) et(U[o], 'cursor', p.cursor || 'move');
                                    ot(q, 'press', 'onPress');
                                }
                            },
                            ue = function(e) {
                                ...
                                if (g && !Te && q.isPressed && e) {
                                    ...
                                    if (Oe) e = $e(e, !0);
                                        ...
                                        if (
                                            ...
                                            ((o = e.pageX),
                                            (n = e.pageY),
                                            X && ((i = o * X[0] + n * X[2] + X[4]), (n = o * X[1] + n * X[3] + X[5]), (o = i)),
                                            (((r = Math.abs(o - h)) !== (s = Math.abs(n - m)) && (j < r || j < s)) || (Fe && B === H)) &&
                                                ((H = s < r && V ? 'x' : 'y'), !1 !== q.vars.lockAxisOnTouchScroll && ((q.lockedAxis = 'x' === H ? 'y' : 'x'), 'function' == typeof q.vars.onLockAxis && q.vars.onLockAxis.call(q, a)), Fe && B === H))
                                        )
                                            return void me(a);
                            ...
                            he = function(e, t) {
                                ...
                                (q.pointerX = e),
                                    (q.pointerY = t),
                                    F
                                        ? ((r = Math.atan2(k.y - t, e - k.x) * Ee), 180 < (s = q.y - r) ? ((v -= 360), (q.y = r)) : s < -180 && ((v += 360), (q.y = r)), q.x !== d || Math.abs(v - r) > j ? ((q.y = r), (i = d + (v - r) * l)) : (i = d))
                                        : (X && ((a = e * X[0] + t * X[2] + X[4]), (t = e * X[1] + t * X[3] + X[5]), (e = a)),
                                          (n = t - m) < j && -j < n && (n = 0),
                                          (o = e - h) < j && -j < o && (o = 0),
                                          (q.lockAxis || q.lockedAxis) &&
                                              (o || n) &&
                                              ((a = q.lockedAxis) || ((q.lockedAxis = a = V && Math.abs(o) > Math.abs(n) ? 'y' : G ? 'x' : null), a && 'function' == typeof q.vars.onLockAxis && q.vars.onLockAxis.call(q, q.pointerEvent)),
                                              'y' === a ? (n = 0) : 'x' === a && (o = 0)),
                                          (i = d + o * l),
                                          (r = v + n * l)),
                                    (L || D || P) && (q.x !== i || (q.y !== r && !F))
                                        ? (P && ((We.x = i), (We.y = r), (i = (a = P(We)).x), (r = a.y)), L && (i = L(i)), D && (r = D(r)))
                                        : x && (w < i ? (i = w + (i - w) * c) : i < b && (i = b + (i - b) * c), F || (T < r ? (r = T + (r - T) * c) : r < S && (r = S + (r - S) * c))),
                                    F || X || ((i = Math.round(i)), (r = Math.round(r))),
                                    (q.x !== i || (q.y !== r && !F)) &&
                                        (F ? ((q.endRotation = q.x = q.endX = i), (M = !0)) : (G && ((q.y = q.endY = r), (M = !0)), V && ((q.x = q.endX = i), (M = !0))),
                                        !q.isDragging && q.isPressed && ((q.isDragging = !0), ot(q, 'dragstart', 'onDragStart')));
                            },
                            me = function(e, t) {
                                if (
                                    g &&
                                    ...
                                    var o,
                                        ...
                                        d = we.delayedCall(0.001, de);
                                    if (
                                        (E ? (dt(E, 'touchend', me), dt(E, 'touchmove', ue), dt(E, 'touchcancel', me), dt(De, 'touchstart', pt)) : dt(De, 'mousemove', ue),
                                        dt(De, 'mouseup', me),
                                        e && e.target && dt(e.target, 'mouseup', me),
                                        (M = !1),
                                        N && !c)
                                    )
                                        return e && (dt(e.target, 'change', me), (q.pointerEvent = a)), ut(U, !1), ot(q, 'release', 'onRelease'), ot(q, 'click', 'onClick'), void (N = !1);
                                    ...
                                    return (
                                        c && a
                                            ? (a.preventDefault(), a.preventManipulation && a.preventManipulation(), ot(q, 'release', 'onRelease'))
                                            : a && !l
                                                ? (Y && (p.snap || p.bounds) && se(p.throwProps),
                                                  ot(q, 'release', 'onRelease'),
                                                  (Fe && 'touchmove' === a.type) ||
                                                      -1 !== a.type.indexOf('cancel') ||
                                                      (ot(q, 'click', 'onClick'),
                                                      Ye() - oe < 300 && ot(q, 'doubleclick', 'onDoubleClick'),
                                                      ...
                                                      (s = function() {
                                                          oe !== z &&
                                                              ...
                                                              (r.click
                                                                  ? r.click()
                                                                  : De.createEvent &&
                                                                    ((i = De.createEvent('MouseEvents')).initMouseEvent('click', !0, !0, window, 1, q.pointerEvent.screenX, q.pointerEvent.screenY, q.pointerX, q.pointerY, !1, !1, !1, !1, 0, null),
                                                                    r.dispatchEvent(i)));
                                                      }),
                                                      Fe || a.defaultPrevented || we.delayedCall(1e-5, s)))
                                                : (se(p.throwProps),
                                                  Oe ||
                                                      q.allowEventDefault ||
                                                      !a ||
                                                      (!p.dragClickables && te.call(q, a.target)) ||
                                                      !l ||
                                                      (B && (!H || B !== H)) ||
                                                      !1 === a.cancelable ||
                                                      (a.preventDefault(), a.preventManipulation && a.preventManipulation()),
                                                  ot(q, 'release', 'onRelease')),
                                        ce() && d.duration(q.tween.duration()),
                                        l && ot(q, 'dragend', 'onDragEnd'),
                                        !0
                                    );
                                }
                            },
                            ...
                            ye = function(e) {
                                return X ? { x: e.x * X[0] + e.y * X[2] + X[4], y: e.x * X[1] + e.y * X[3] + X[5] } : { x: e.x, y: e.y };
                            };
                        (e = mt.get(this.target)) && e.kill(),
                            (this.startDrag = function(e, t) {
                                var o, n, i, r;
                                fe(e || q.pointerEvent, !0),
                                    t &&
                                        !q.hitTest(e || q.pointerEvent) &&
                                        ((o = vt(e || q.pointerEvent)), (n = vt(f)), (i = ye({ x: o.left + o.width / 2, y: o.top + o.height / 2 })), (r = ye({ x: n.left + n.width / 2, y: n.top + n.height / 2 })), (h -= i.x - r.x), (m -= i.y - r.y)),
                                    q.isDragging || ((q.isDragging = !0), ot(q, 'dragstart', 'onDragStart'));
                            }),
                            (this.drag = ue),
                            ...
                            (this.getDirection = function(e, t) {
                                ...
                                return (
                                    'element' === l && ((s = vt(q.target)), (a = vt(e))),
                                    (o = 'start' === l ? q.x - d : 'velocity' === l ? Se.getVelocity(this.target, I) : s.left + s.width / 2 - (a.left + a.width / 2)),
                                    F
                                        ? o < 0
                                            ? 'counter-clockwise'
                                            : 'clockwise'
                                        : ((t = t || 2),
                                          (n = 'start' === l ? q.y - v : 'velocity' === l ? Se.getVelocity(this.target, W) : s.top + s.height / 2 - (a.top + a.height / 2)),
                            ...
                            (this.applyBounds = function(e) {
                                ...
                                if ((a(!0), l(), x)) {
                                    if (
                                        ...
                                        w < t ? (t = w) : t < b && (t = b),
                                        T < o ? (o = T) : o < S && (o = S),
                                        (q.x !== t || q.y !== o) && ((n = !0), (q.x = q.endX = t), F ? (q.endRotation = t) : (q.y = q.endY = o), ne((M = !0)), q.autoScroll && !q.isDragging))
                                    )
                                        for (
                                            Qe(f.parentNode),
                                                i = f,
                                            ...
                                            (r = (s = Ke(i.parentNode)) ? Ve : i.parentNode), G && r.scrollTop > r._gsMaxScrollY && (r.scrollTop = r._gsMaxScrollY), V && r.scrollLeft > r._gsMaxScrollX && (r.scrollLeft = r._gsMaxScrollX), (i = r);
                            ...
                            (this.update = function(e, t, o) {
                                ...
                                return (
                                    ae(!t),
                                    e ? q.applyBounds() : (M && o && ne(!0), a(!0)),
                                    t && (he(q.pointerX, q.pointerY), M && ne(!0)),
                                    q.isPressed && !t && ((V && 0.01 < Math.abs(n - q.x)) || (G && 0.01 < Math.abs(i - q.y) && !F)) && le(),
                                    q.autoScroll && (Qe(f.parentNode), (K = q.isDragging), ne(!0)),
                                    q.autoScroll && (Ze(f, ve), Ue(f, ve)),
                                    q
                                );
                            }),
                            (this.enable = function(e) {
                                ...
                                return (
                                    Ue(f, ve),
                                    (g = !0),
                                    Se && 'soft' !== e && Se.track(u || f, A ? 'x,y' : F ? 'rotation' : 'top,left'),
                                    u && u.enable(),
                                    (f._gsDragID = t = 'd' + ze++),
                                    (Re[t] = this),
                            ...
                            F ? (n.rotation = 1) : (V && (n[I] = 1), G && (n[W] = 1)),
                            F ? ((r = (i = Me).css), (i.overwrite = !1)) : A && ((r = (i = V && G ? _e : V ? Ce : ke).css), (i.overwrite = !1)),
                            this.enable();
                    },
                    G = (mt.prototype = new o());
                (G.constructor = mt),
                    (G.pointerX = G.pointerY = G.startX = G.startY = G.deltaX = G.deltaY = 0),
                    (G.isDragging = G.isPressed = !1),
                    (mt.version = '0.16.3'),
                    (mt.zIndex = 1e3),
                                        ...
                                        ? I(e)
                                            ? (function(e) {
                                                  var t,
                                                      ...
                                                      r = e.length;
                                                  for (t = 0; t < r; t++)
                                                      if (((o = e[t]), I(o))) for (n = o.length, n = 0; n < o.length; n++) i.push(o[n]);
                ...
                var j = {},
                    vt = function(e, t) {
                        if (e === window)
                            return (
                                (j.left = j.top = 0),
                                (j.width = j.right = Pe.clientWidth || e.innerWidth || De.body.clientWidth || 0),
                                (j.height = j.bottom = (e.innerHeight || 0) - 20 < Pe.clientHeight ? Pe.clientHeight : e.innerHeight || De.body.clientHeight || 0),
                                j
                            );
                        var o =
                            e.pageX !== t
                                ? { left: e.pageX - L(), top: e.pageY - M(), right: e.pageX - L() + 1, bottom: e.pageY - M() + 1 }
                                : e.nodeType || e.left === t || e.top === t
                                    ? Oe
                                        ? (function(e) {
                                              ...
                                              return { top: n, left: i, width: t, height: o };
                                          })(e)
                        ...
                        return (
                            o.right === t && o.width !== t
                                ...
                                : o.width === t && (o = { width: o.right - o.left, height: o.bottom - o.top, right: o.right, left: o.left, bottom: o.bottom, top: o.top }),
                            o
                        );
                    };
                return (
                    (mt.hitTest = function(e, t, o) {
                        ...
                        return l || !o
                            ...
                            : ((r = -1 !== (o + '').indexOf('%')),
                              (o = parseFloat(o) || 0),
                              ((n = { left: Math.max(s.left, a.left), top: Math.max(s.top, a.top) }).width = Math.min(s.right, a.right) - n.left),
                              (n.height = Math.min(s.bottom, a.bottom) - n.top),
                              !(n.width < 0 || n.height < 0) && (r ? ((o *= 0.01), (i = n.width * n.height) >= s.width * s.height * o || i >= a.width * a.height * o) : n.width > o && n.height > o));
                    }),
