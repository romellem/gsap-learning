        ...
        function(r, b, S, T) {
            var _,
                ...
                D = (N.calculateChange = function(e, t, r, o) {
                    return null == o && (o = 0.05), (r * o * e) / (t instanceof S ? t : t ? new S(t) : b.defaultEase).getRatio(o);
                }),
                ...
                s = (N.calculateTweenDuration = function(e, t, r, o, n, i) {
                    ...
                    null == r && (r = 10), null == o && (o = 0.2), null == n && (n = 1), e.length && (e = e[0] || e);
                    var s,
                        a,
                        c,
                        u,
                        ...
                        k = isNaN(P.checkpoint) ? 0.05 : Number(P.checkpoint),
                        x = isNaN(P.resistance) ? N.defaultResistance : Number(P.resistance);
                    if (P.linkedProps)
                        for (m = P.linkedProps.split(','), v = {}, y = 0; y < m.length; y++)
                            (a = P[(s = m[y])]) &&
                                ((c =
                                    0 <
                                    (u = void 0 !== a.velocity && 'number' == typeof a.velocity ? Number(a.velocity) || 0 : (d = d || T.getByTarget(e)) && d.isTrackingProp(s) ? d.getVelocity(s) : 0) * (f = isNaN(a.resistance) ? x : Number(a.resistance))
                                        ? u / f
                                        : u / -f),
                                (p = 'function' == typeof e[s] ? e[s.indexOf('set') || 'function' != typeof e['get' + s.substr(3)] ? s : 'get' + s.substr(3)]() : e[s] || 0),
                                (v[s] = p + D(u, C, c, k)));
                    for (s in P)
                        'resistance' !== s &&
                            'checkpoint' !== s &&
                            ...
                            'linkedProps' !== s &&
                            'radius' !== s &&
                            ('object' != typeof (a = P[s]) && ((d = d || T.getByTarget(e)) && d.isTrackingProp(s) ? (a = 'number' == typeof a ? { velocity: a } : { velocity: d.getVelocity(s) }) : (c = 0 < (u = Number(a) || 0) * x ? u / x : u / -x)),
                            'object' == typeof a &&
                                ((c =
                                    0 <
                                    (u = void 0 !== a.velocity && 'number' == typeof a.velocity ? Number(a.velocity) || 0 : (d = d || T.getByTarget(e)) && d.isTrackingProp(s) ? d.getVelocity(s) : 0) * (f = isNaN(a.resistance) ? x : Number(a.resistance))
                                        ? u / f
                                        : u / -f),
                                (l = (p = 'function' == typeof e[s] ? e[s.indexOf('set') || 'function' != typeof e['get' + s.substr(3)] ? s : 'get' + s.substr(3)]() : e[s] || 0) + D(u, C, c, k)),
                                void 0 !== a.end && ((a = j(a, v && s in v ? v : l, a.max, a.min, s, P.radius)), (i || V) && (P[s] = F(a, P[s], 'end'))),
                                void 0 !== a.max && l > Number(a.max) + 1e-10
                                    ? ((h = a.unitFactor || N.defaultUnitFactors[s] || 1), (g = (p > a.max && a.min !== a.max) || (-15 < u * h && u * h < 45) ? o + 0.1 * (r - o) : E(p, a.max, u, C, k)) + n < w && (w = g + n))
                                    : void 0 !== a.min &&
                                      l < Number(a.min) - 1e-10 &&
                                      ((h = a.unitFactor || N.defaultUnitFactors[s] || 1), (g = (p < a.min && a.min !== a.max) || (-45 < u * h && u * h < 15) ? o + 0.1 * (r - o) : E(p, a.min, u, C, k)) + n < w && (w = g + n)),
                                _ < g && (_ = g)),
                            _ < c && (_ = c));
            ...
            return (
                            ...
                            parser: function(e, t, r, o, n, i) {
                                ...
                                for (a in ((w = {}), t))
                                    'resistance' !== a &&
                                        ...
                                        'radius' !== a &&
                                        ('object' == typeof (s = t[a])
                                            ? (void 0 !== s.velocity && 'number' == typeof s.velocity ? (f[a] = Number(s.velocity) || 0) : ((u = u || T.getByTarget(e)), (f[a] = u && u.isTrackingProp(a) ? u.getVelocity(a) : 0)),
                                              void 0 !== s.end && (g[a] = s.end),
                                              void 0 !== s.min && (p[a] = s.min),
                                              void 0 !== s.max && (l[a] = s.max),
                                              s.preventOvershoot && (h[a] = !0),
                                              void 0 !== s.resistance && (!0, (d[a] = s.resistance)))
                                            : 'number' == typeof s
                                                ? (f[a] = s)
                                ...
                                for (a in ((c = v(e, f, o, n, i)), (_ = c.proxy), (f = c.end), _)) w[a] = { velocity: f[a], min: p[a], max: l[a], end: g[a], resistance: d[a], preventOvershoot: h[a] };
                                return (
                ...
                (N.to = function(e, t, r, o, n) {
                    ...
                    return (
                        i.render(0, !0, !0),
                        i.vars.css ? (i.duration(s(_, { throwProps: w, ease: t.ease }, r, o, n)), i._delay && !i.vars.immediateRender ? i.invalidate() : P._onInitTween(_, C, i)) : (i.kill(), (i = new b(e, s(e, t, r, o, n), t))),
                        (V = !1),
                        i
                    );
                }),
                (e._onInitTween = function(e, t, r, o) {
                    ...
                    if (t.linkedProps)
                        for (d = t.linkedProps.split(','), g = {}, h = 0; h < d.length; h++)
                            (i = t[(n = d[h])]) &&
                                ((c = void 0 !== i.velocity && 'number' == typeof i.velocity ? Number(i.velocity) || 0 : (l = l || T.getByTarget(e)) && l.isTrackingProp(n) ? l.getVelocity(n) : 0),
                                (s = 'function' == typeof e[n] ? e[n.indexOf('set') || 'function' != typeof e['get' + n.substr(3)] ? n : 'get' + n.substr(3)]() : e[n] || 0),
                                (g[n] = s + D(c, v, y, m)));
                    for (n in t)
                        if ('resistance' !== n && 'checkpoint' !== n && 'preventOvershoot' !== n && 'linkedProps' !== n && 'radius' !== n) {
                            ...
                            (u = D(c, v, y, m)),
                                (p = 0),
                                (s = (a = 'function' == typeof e[n]) ? e[n.indexOf('set') || 'function' != typeof e['get' + n.substr(3)] ? n : 'get' + n.substr(3)]() : e[n]),
                                'object' == typeof i &&
                                    ((f = s + u),
                                    void 0 !== i.end && ((i = j(i, g && n in g ? g : f, i.max, i.min, n, t.radius)), V && (t[n] = F(i, t[n], 'end'))),
                                    void 0 !== i.max && Number(i.max) < f ? (_ || i.preventOvershoot ? (u = i.max - s) : (p = i.max - s - u)) : void 0 !== i.min && Number(i.min) > f && (_ || i.preventOvershoot ? (u = i.min - s) : (p = i.min - s - u))),
                ...
                (e.setRatio = function(e) {
                    for (var t, r, o = this._props.length; -1 < --o; )
                        (r = (t = this._props[o]).s + t.c1 * e + t.c2 * e * e), t.m ? (r = t.m(r, this.target)) : 1 === e && (r = ((1e4 * r + (r < 0 ? -0.5 : 0.5)) | 0) / 1e4), t.f ? this.target[t.p](r) : (this.target[t.p] = r);
                }),
                r.activate([N]),
                N
            );
            ...
            function(s) {
                var i,
                    ...
                    p = function(e, t, r) {
                        ...
                        return o || 0 === o
                            ? o
                            : (e.style[t] ? (o = e.style[t]) : (r = r || f(e, null)) ? (o = r[t] || r.getPropertyValue(t) || r.getPropertyValue(t.replace(a, '-$1').toLowerCase())) : e.currentStyle && (o = e.currentStyle[t]), parseFloat(o) || 0);
                    },
                    l = s.ticker,
                    g = function(e, t, r) {
                    ...
                    r = function() {
                        ...
                        if (0.03 <= o - n)
                            for (n, n = o; r; ) {
                                for (t = r._firstVP; t; ) ((e = t.css ? p(r.target, t.p) : t.f ? r.target[t.p]() : r.target[t.p]) !== t.v1 || 0.15 < o - t.t1) && ((t.v2 = t.v1), (t.v1 = e), (t.t2 = t.t1), (t.t1 = o)), (t = t._next);
                                r = r._next;
                            }
                    },
                    d = function(e) {
                    ...
                    (e.addProp = function(e, t) {
                        if (!this._lookup[e]) {
                            var r = this.target,
                                ...
                                i = this._firstVP;
                            (this._firstVP = this._lookup[e] = this._lookup[n] = i = new g(n !== e && 0 === e.indexOf('set') ? n : e, o, i)),
                                (i.css = this.elem && (void 0 !== this.target.style[i.p] || u[i.p])),
                                i.css && u[i.p] && !r._gsTransform && s.set(r, { x: '+=0', overwrite: !1 }),
                                (i.type = t || (i.css && 0 === e.indexOf('rotation')) ? 'deg' : ''),
                                (i.v1 = i.v2 = i.css ? p(r, i.p) : o ? r[i.p]() : r[i.p]);
                        }
                    }),
