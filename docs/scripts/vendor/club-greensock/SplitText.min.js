...
!(function(r) {
    ...
    var o = r.GreenSockGlobals || r,
        ...
        n = (function(e) {
            for (
                var t = -1 !== (r ? r.location.href : '').indexOf(String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107)) && -1 !== e.indexOf(String.fromCharCode(108, 111, 99, 97, 108, 104, 111, 115, 116)),
                    i = [
                        l,
            ...
            (this.elements = a(e)
                ? (function(e) {
                      var t,
                          ...
                          o = e.length;
                      for (t = 0; t < o; t++)
                          if (((i = e[t]), a(i))) for (n = i.length, n = 0; n < i.length; n++) r.push(i[n]);
                          else r.push(i);
                      return r;
                  })(e)
                : [e]),
        ...
        Q = function(e) {
            var t,
                ...
                r = n.length;
            for (t = 0; t < r; t++)
                (i = n[t])._isSplit ? Q(i) : (t && 3 === i.previousSibling.nodeType ? (i.previousSibling.nodeValue += 3 === i.nodeType ? i.nodeValue : i.firstChild.nodeValue) : 3 !== i.nodeType && e.insertBefore(i.firstChild, i), e.removeChild(i));
        },
            ...
            if (E || j)
                for (l = 0; l < a; l++)
                    ((f = (h = p[l]).parentNode === e) || j || (R && !k)) &&
                        ((m = h.offsetTop),
                        E && f && Math.abs(m - b) > w && ('BR' !== h.nodeName || 0 === l) && ((u = []), E.push(u), (b = m)),
                        j && ((h._x = h.offsetLeft), (h._y = m), (h._w = h.offsetWidth), (h._h = h.offsetHeight)),
                        E &&
                            (((h._isSplit && f) || (!R && f) || (k && f) || (!k && h.parentNode.parentNode === e && !h.parentNode._isSplit)) && (u.push(h), (h._x -= y), P(h, e, O) && (h._wordEnd = !0)),
            ...
            for (l = 0; l < a; l++)
                (f = (h = p[l]).parentNode === e),
                    'BR' !== h.nodeName
                        ? (j &&
                              ((g = h.style),
                              k || f || ((h._x += h.parentNode._x), (h._y += h.parentNode._y)),
                              (g.left = h._x + 'px'),
                              (g.top = h._y + 'px'),
                              (g.position = 'absolute'),
                              (g.display = 'block'),
                              ...
                              ? h._isSplit
                                  ...
                                  : h.parentNode._isSplit
                                      ? ((h._parent = h.parentNode),
                                        ...
                                        a--)
                                      : f ||
                                        ((m = !h.nextSibling && P(h.parentNode, e, O)), h.parentNode._parent && h.parentNode._parent.appendChild(h), m && h.parentNode.appendChild(q.createTextNode(' ')), t.span && (h.style.display = 'inline'), L.push(h))
                              : h.parentNode._isSplit && !h._isSplit && '' !== h.innerHTML
                                  ? B.push(h)
                                  : R && !h._isSplit && (t.span && (h.style.display = 'inline'), L.push(h)))
                        : E || j
                            ? (h.parentNode && h.parentNode.removeChild(h), p.splice(l--, 1), a--)
                            : k || e.appendChild(h);
            for (l = $.length; -1 < --l; ) $[l].parentNode.removeChild($[l]);
            if (E) {
                for (j && ((C = q.createElement(W)), e.appendChild(C), (S = C.offsetWidth + 'px'), (m = C.offsetParent === e ? 0 : e.offsetLeft), e.removeChild(C)), g = e.style.cssText, e.style.cssText = 'display:none;'; e.firstChild; )
                    e.removeChild(e.firstChild);
                for (c = ' ' === O && (!j || (!k && !R)), l = 0; l < E.length; l++) {
                    for (u = E[l], (C = q.createElement(W)).style.cssText = 'display:block;text-align:' + A + ';position:' + (j ? 'absolute;' : 'relative;'), M && (C.className = M + (G ? l + 1 : '')), V.push(C), a = u.length, d = 0; d < a; d++)
                        'BR' !== u[d].nodeName &&
                            ((h = u[d]),
                            C.appendChild(h),
                            c && h._wordEnd && C.appendChild(q.createTextNode(' ')),
                            j && (0 === d && ((C.style.top = h._y + 'px'), (C.style.left = y + m + 'px')), (h.style.top = '0px'), m && (h.style.left = h._x - m + 'px')));
                    0 === a ? (C.innerHTML = '&nbsp;') : k || R || (Q(C), F(C, String.fromCharCode(160), ' ')), j && ((C.style.width = S), (C.style.height = h._h + 'px')), e.appendChild(C);
                }
                e.style.cssText = g;
            }
            j && (s > e.clientHeight && ((e.style.height = s - T + 'px'), e.clientHeight < s && (e.style.height = s + v + 'px')), o > e.clientWidth && ((e.style.width = o - N + 'px'), e.clientWidth < o && (e.style.width = o + _ + 'px'))),
                I(i, L),
                I(n, B),
                I(r, V);
        },
        g = function(e, t, i, n) {
            ...
            if (3 !== e.nodeType || 1 < l) {
                for (t.absolute = !1, r = 0; r < l; r++)
                    (3 !== (o = s[r]).nodeType || /\S+/.test(o.nodeValue)) && (d && 3 !== o.nodeType && 'inline' === D(o, 'display', null, !0) && ((o.style.display = 'inline-block'), (o.style.position = 'relative')), (o._isSplit = !0), g(o, t, i, n));
            ...
            !(function(e, t, i, n) {
                ...
                for (
                    ...
                    if (((a = r.charAt(s)), b && (u = b(r.substr(s), t.specialChars)))) (a = r.substr(s, u || 1)), (o += g && ' ' !== a ? n() + a + '</' + c + '>' : a), (s += u - 1);
                        ...
                        s === d - 1 ? (o += m) : ')' !== r.charAt(s + 1) && ((o += m + i()), (y = !0));
                    } else
                        '{' === a && '{{LT}}' === r.substr(s, 6)
                            ? ((o += g ? n() + '{{LT}}</' + c + '>' : '{{LT}}'), (s += 5))
                            : (55296 <= a.charCodeAt(0) && a.charCodeAt(0) <= 56319) || (65024 <= r.charCodeAt(s + 1) && r.charCodeAt(s + 1) <= 65039)
                                ? ((p = V(r.substr(s, 2))),
                                  (f = V(r.substr(s + 2, 2))),
                                  (l = (L <= p && p <= B && L <= f && f <= B) || (127995 <= f && f <= 127999) ? 4 : 2),
                                  (o += g && ' ' !== a ? n() + r.substr(s, l) + '</' + c + '>' : r.substr(s, l)),
                                  (s += l - 1))
                                : (o += g && ' ' !== a ? n() + a + '</' + c + '>' : a);
    ...
    (t.split = function(e) {
        ...
        for (var t, i, n, r = this.elements.length, o = e.span ? 'span' : 'div', s = p(e.wordsClass, o), l = p(e.charsClass, o); -1 < --r; )
            (n = this.elements[r]), (this._originals[r] = n.innerHTML), (t = n.clientHeight), (i = n.clientWidth), g(n, e, s, l), c(n, e, this.chars, this.words, this.lines, i, t);
